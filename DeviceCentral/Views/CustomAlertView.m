...
@property (nonatomic) UIView *dialogContainer;
...
- (IBAction)customDialogButtonTouchUpInside:(id)sender
{
    if (self.delegate != NULL) {
        [self.delegate customDialogButtonTouchUpInside:self clickedButtonAtIndex:[sender tag]];
    }
...
- (void)keyboardWillShow:(NSNotification *)notification {
    [self animateViewForKeyboard:notification direction:YES];
}

- (void)keyboardWillHide:(NSNotification *)notification {
    [self animateViewForKeyboard:notification direction:NO];
}

-(void)animateViewForKeyboard: (NSNotification*) notification direction: (BOOL) direction
{
    return;
    ...
    CGFloat size = isPortrait ? keyboardFrame.size.height : keyboardFrame.size.width;
    
    [UIView animateWithDuration:animationDuration animations:^{
        CGRect frame = self.dialogContainer.frame;
        ...
        self.dialogContainer.frame = frame;
    }];
}
